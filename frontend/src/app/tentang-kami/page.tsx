          ...
          <FadeInFromLeft>
            <div className="flex flex-col max-w-lg gap-4 w-full md:w-1/2 mx-auto">
              <p className="text-base text-primaryTextColor">
                ...
                konsultasi dengan psikolog profesional, AI Chatbot untuk
                menjawab pertanyaan mental health, serta konten edukatif dan
                terapi berbasis musik.
              </p>
              <p className="text-base text-primaryTextColor">
                Dibangun oleh tim ahli di bidang psikologi, teknologi, dan
                kesehatan, Warasin berkomitmen untuk memberikan layanan yang
                aman, nyaman, dan mudah diakses. Kami percaya bahwa setiap
        ...
        <FadeInFromRight>
          <section className="flex flex-col mt-40 items-center gap-20">
            <div className="flex flex-col text-center mx-auto w-3/5 gap-4">
              ...
              <p className="text-base text-primaryTextColor">
                Kami percaya bahwa kesehatan mental adalah hak semua orang.
                Budaya Warasin mengedepankan empati, inovasi, dan komitmen dalam
